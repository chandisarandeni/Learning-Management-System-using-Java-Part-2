...
public class AdminViewTimetable extends javax.swing.JFrame {
    ...
    /**
     * Creates new form AdminViewTimetable
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminViewTimetable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminViewTimetable().setVisible(true);
            }
        });
    }
