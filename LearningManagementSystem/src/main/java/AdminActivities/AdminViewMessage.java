 ...
 * @author chand
 */
public class AdminViewMessage extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminViewMessage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
