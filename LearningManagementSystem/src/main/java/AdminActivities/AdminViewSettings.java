 ...
 * @author chand
 */
public class AdminViewSettings extends javax.swing.JFrame {

    /**
     * Creates new form AdminViewSettings
     */
    
    private final DrawerController drawer;
    public String adminUsername;
    
    public AdminViewSettings(String adminUsername) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminViewSettings.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminViewSettings("").setVisible(true);
            }
        });
    }
