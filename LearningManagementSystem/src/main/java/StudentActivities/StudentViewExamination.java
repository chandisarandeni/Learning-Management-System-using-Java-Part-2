 ...
 * @author chand
 */
public class StudentViewExamination extends javax.swing.JFrame {

    /**
     * Creates new form StudentViewExamination
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentViewExamination.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
