 ...
 * @author chand
 */
public class StudentViewMessages extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentViewMessages.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
