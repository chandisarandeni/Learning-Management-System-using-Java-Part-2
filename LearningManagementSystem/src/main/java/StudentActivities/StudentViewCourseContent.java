 ...
 * @author chand
 */
public class StudentViewCourseContent extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentViewCourseContent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
